...
public class EditCityFragment extends DialogFragment {
    interface EditCityDialogListener {
        void editCity(String newName, String newProv); //might have to change
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        EditText editCityName = view.findViewById(R.id.edit_text_city_text);//change to selected city?
